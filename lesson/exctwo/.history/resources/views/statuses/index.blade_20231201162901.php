    ...
    <div class="container-fluid">
            ...
            <form action="{{route('statuses.store')}}" method="POST" enctype="multipart/form-data">          
               ...
               <div class="row align-items-end">
                   <div class="col-md-6 form-group">
                       ...
                       <input type="text" name="editname" id="name" class="form-control form-control-sm rounded-0" placeholder="Enter your name" value="{{old('name')}}" />
                   </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a id="helo" href="javascript:void(0);" class="text-info editform" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$status->id}}" data-name="{{$status->name}}"><i class="fas fa-pen"></i></a>
