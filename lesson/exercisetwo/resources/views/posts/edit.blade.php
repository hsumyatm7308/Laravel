        ...
        <form action="/posts/{{$post->id}}" method="POST" enctype="multi/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12 form-group mb-3">
                    <div class="row">
                            <div class="col-md-6">
                                 <img src="{{asset($post->image}}" width="200" alt="{{$post->title}}"> </img>
                             </div>
                    </div>
                    <label for="image">Choose Images <span class="text-danger">*</span></label>
                    <input type="image" name="image" class="form-control form-control-sm rounded-0"
