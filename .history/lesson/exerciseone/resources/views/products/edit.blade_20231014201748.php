...
<form action="/countries/{{$country->id}}" method="POST" class="container">
  ...
  @method('PATCH')
    ...
    <div class="col-md-6 form-group mb-3">
        ...
        <input type="text" name="price" class="form-control form-control-sm rounded-0" value="{{$product->capital}}">
    </div>

    <div class="col-md-6 form-group mb-3">
        <label for="currency">Image</label>
        <input type="text" name="currency" class="form-control form-control-sm rounded-0" value="{{$product->currency}}">
