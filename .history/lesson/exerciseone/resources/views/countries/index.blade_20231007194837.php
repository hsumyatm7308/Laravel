    ...
    <tbody>
      ...
      {{--  {{url('countries',$country['id'])}} --}}
            ...
            {{-- <a href="{{url('countries',$country['id'])}}" class="text-danger"><i class="fas fa-trash-alt"></i></a> --}}
             ...
             <form class="formdelete" action="{{route('countries.destroy',$country->id)}}"  method="POST" class="d-flex justify-content-center align-items-center">
                @csrf 
                @method("DELETE")
            ...
            <td>
                <a href="#" class="btn btn-danger" onclick="event.preventDefault();document.getElementById('formdelete-{{$country->id}}').submit();">Delete</a>
            </td>
