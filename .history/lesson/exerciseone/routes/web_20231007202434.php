...
Route::get('/dates',function(){
    ...
    echo $date->format('m-d-Y'); // 10-12-2023
    echo "<br>";


    
    $date = new DateTime('+5 week');
    echo $date->format('m-d-Y'); //11-11-2023
    echo "<br>";


    echo "<hr>";

    echo Carbon::now(); //2023-10-07 13:41:15
    echo "<br>";


    echo Carbon::now()->addDays(10); //2023-10-17 13:42:07
    echo "<br>";

    echo Carbon::now()->addDays(1)->diffForHumans(); //2023-10-17 13:42:07
    echo "<br>";
    ...
    echo Carbon::now()->addMonths(3)->diffForHumans(); // 3 days ago 
    echo "<br>";



    echo Carbon::now()->addMonths(1)->diffForHumans(); // 3 days ago 
    echo "<br>";



    echo Carbon::now()->subMonths(1)->diffForHumans(); // 3 days ago 
    echo "<br>";
