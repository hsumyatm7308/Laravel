                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-2 col-md-3 fixed-top vh-100 overflow-auto sidebars">
                        <ul class="navbar-nav flex-column mt-4">
                            ...
                            <li class="nav-item"><a href="" class="nav-link text-white p-3 mb-2 sidebarlinks" data-bs-target="#chartelement" data-bs-toggle="collapse"><i class="fas fa-file-alt fa-lg me-3"></i>Roles<i class="fas fa-angle-left mores"></i></a>

                            <li class="nav-item"><a href="{{route('statuses.index')}}" class="nav-link text-white p-3 mb-2 sidebarlinks" data-bs-target="#chartelement" data-bs-toggle="collapse"><i class="fas fa-file-alt fa-lg me-3"></i>Status<i class="fas fa-angle-left mores"></i></a>
