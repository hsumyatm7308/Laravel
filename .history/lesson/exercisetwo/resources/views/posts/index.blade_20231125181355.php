...
<div class="container-fluid">
    <div class="col-md-12">
        ...
        <div class="col-md-12 ">
            <a href="{{route('students.create')}}" class="btn btn-primary btn-sm rounded-0">a</a>
            <hr>
        </div>
        <div class="col-md-12">
            ...
            <table class="table table-sm table-hover border container">
                ...
                <tbody> @foreach($students as $idx=>$student) <tr>
                        ...
                        <td class="d-flex justify-content-center align-items-center">
                            ...
                            <a href="#" class="text-danger m-3 delete-btn" data-idx="{{$student->regnumber}}"><i class="fas fa-trash-alt"></i></a>
                        ...
                        <form class="formdelete-{{$student->regnumber}}" id="" action="{{route('students.destroy',$student->id)}}" method="POST" class="d-flex  justify-content-center align-items-center">
                                @csrf
                                @method("DELETE")
