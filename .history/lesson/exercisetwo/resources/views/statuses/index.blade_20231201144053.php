    ...
    <div class="container-fluid">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="statuses.edit" class="text-info editform" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$status->id}}" data-name="{{$status->name}}"><i class="fas fa-pen"></i></a>
