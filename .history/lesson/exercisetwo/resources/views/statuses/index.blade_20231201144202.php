    ...
    <div class="container-fluid">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="statuses.edit,$status->id" class="text-info editform" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$status->id}}" data-name="{{$status->name}}"><i class="fas fa-pen"></i></a>
                    
                    <a href="#" class="text-danger ms-2 delete-btns" data-idx="{{$status->$idx}}"><i class="fas fa-trash-alt"></i></a>                   
                </td>
                <form id="formdelete-{{$status->$idx}}" action="{{route('statuses.destroy',$status -> id)}}" method="POST">
                    @csrf 
                    @method('DELETE')
