            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{route('statuses.edit',$student->id)}}" class="text-info m-3">
                            <i class="fas fa-pen"></i></a>

                        <a href="#" class="text-danger m-3 delete-btn" data-idx="{{$student->regnumber}}"><i
                                class="fas fa-trash-alt"></i></a>

                    </td>

                    <form class="formdelete-{{$student->regnumber}}" id=""
