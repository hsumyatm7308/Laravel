        ...
        <table id="mytable" class="mydata table table-warning table-hover border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="statuses.edit,$status->id" class="text-info editform" data-bs-toggle="modal"
                            data-bs-target="#editmodal" data-id="{{$status->id}}" data-name="{{$status->name}}"><i
                                class="fas fa-pen"></i></a>

                        <a href="#" class="text-danger ms-2 delete-btns" data-idx="{{$idx}}"><i
