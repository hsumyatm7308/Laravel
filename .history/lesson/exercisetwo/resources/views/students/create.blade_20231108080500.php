...
<div class="container-fluid">
    ...
    <div class="col-md-4 form-group mb-3">
        ...
        <input type="text" name="lastname" class="form-control form-control-sm rounded-0" placeholder="Enter Last Name" value="{{old('lastname')}}">
    </div>
    ...
    <div class="col-md-12">
        ...
        <textarea name="remark"  id="remark" class="form-control form-control-sm rounded-0" rows="3">{{old('firstname')}}</textarea>
