        ...
        <div class="col-md-12">
            ...
            <table class="table table-sm table-hover border container">
                ...
                <tbody> @foreach($students as $idx=>$student) <tr>
                        ...
                        <td>{{Str::limit($student->remark)}}</td>
                        ...
                        <td>
                            <a href="#" class="btn btn-danger"
                                onclick="event.preventDefault();document.getElementById('formdelete{{$student->id}}').submit();">Delete</a>
                        </td>
                        <form id="formdelete{{$student->id}}" action=" {{url('/students',$student['id'])}}"
                            method="POST">
                            {{ csrf_field()}}
                            {{method_field('DELETE')}}
                        </form>
