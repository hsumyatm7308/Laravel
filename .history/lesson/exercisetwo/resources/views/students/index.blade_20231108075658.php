        ...
        <div class="col-md-12">
            ...
            <table class="table table-sm table-hover border container">
                ...
                <tbody> @foreach($students as $idx=>$country) <tr>
                        <td>{{++$idx}}</td>
                        <td><a href="{{route('students.show',$country->id)}}">{{$country->regnumber}}</a></td>
                        <td>{{$country->regnumber}}</td>
                        ...
                        <td class="d-flex justify-content-center align-items-center">
                            ...
                            {{-- <a href="{{url('students',$country['id'])}}" class="text-danger"><i
                                    class="fas fa-trash-alt"></i></a>
                            --}}

                            <a href="{{route('students.edit',$country->id)}}" class="text-info m-3"><i
                                    class="fas fa-pen"></i></a>

                            <form class="formdelete" action="{{route('students.destroy',$country->id)}}" method="POST"
