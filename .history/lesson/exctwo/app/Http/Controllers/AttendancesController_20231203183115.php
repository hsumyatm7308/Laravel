...
class AttendancesController extends Controller
{
    ...
    public function index()
    {
        ...
        // $posts = Post::where('attshow',[4])->get();
        $posts = DB::table('posts')->where('attshow',4)->orderBy('title','asc')->get(); // can't call as array , just can call as object 
    ...
    {
        $this -> validate($request,[
            'post_id' => ['required','max:50','unique:attendances,name,'.$id],
            'attcode' => ['required','in:3,4']
        ]);
