        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="#" class="text-danger ms-2 delete-btns" data-idx="{{$tag -> id}}"><i class="fas fa-trash-alt"></i></a>                   
                </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0">
            ...
            <div class="modal-header">
                ...
                <button type="tag" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
