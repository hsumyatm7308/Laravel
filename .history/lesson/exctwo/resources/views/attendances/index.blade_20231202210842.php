            ...
            <form action="{{route('attendances.store')}}" method="POST" encattendance="multipart/form-data">          
               ...
               <div class="row align-items-end">
                   <div class="col-md-4 form-group">
                       <label for="name"> Class Date <span class="text-danger">*</span></label>

                       <input attendance="text" name="name" id="name" class="form-control form-control-sm rounded-0" placeholder="Enter your name" value="{{old('name')}}" />
                   </div>
