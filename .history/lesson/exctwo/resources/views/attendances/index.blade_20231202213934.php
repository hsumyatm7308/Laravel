        ...
        <form action="{{ route('attendances.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row align-items-end">
                <div class="col-md-3 form-group">
                    ...
                    <input attendance="text" name="classdate" id="classdate"
                ...
                <tr>
                    ...
                    <td>
                        <a href="javascript:void(0);" class="text-info editform" data-bs-toggle="modal"
                            ...
                            data-name="{{ $attendance->name }}" data-status="{{ $attendance->status_id }}">
                ...
                <form id="formaction" action="" method="POST" encattendance="multipart/form-data">
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-7 form-group">
                            <label for="editname"> Class <span class="text-danger">*</span></label>

                            <input attendance="text" name="editname" id="editname"
                                class="form-control form-control-sm rounded-0" placeholder="Enter your name"
                                value="{{old('name')}}" />
                        </div>

                        <div class="col-md-3 form-group">
                            <label for="editpost_id"> Status <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-7 form-group">
                            <label for="editattcode"> Class <span class="text-danger">*</span></label>

                            <input attendance="text" name="attcode" id="editattcode"
                                class="form-control form-control-sm rounded-0" placeholder="Enter your name"
                                value="{{old('name')}}" />
                        </div>
