...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        ...
        <a href="{{route('posts.show')}}" class="btn btn-secondary btn-sm rounded-0 mb-3">Close</a>
        <hr />
                ...
                <div class="col-md-12">
                    <div class="card rounded-0">
                            ...
                            <ul class="list-group chat-boxs">
                                @foreach($comments as $comment)
                                   <li class="list-group-item mt-2">
                                       ...
                                       <div>
                                        <span class="small fw-bold float-end"> {{$comment->user_id}} |     {{$comment->created_at->diffForHuman()}}</span> 
                        ...
                        <div class="card-body border-top">
                            <form action="{{routes('comments.store')}}" method="">
                                @csrf 
