...
<div class="container-fluid">
    ...
    <a href="{{route('posts.index')}}" class="btn btn-secondary btn-sm rounded-0 mb-3">Close</a>
        <a href="#createmodel" class="btn btn-primary btn-sm rounded-0 mb-3">Enroll</a>
        <hr />
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0">
            ...
            <div class="modal-body">
                ...
                <form id="{{route(categories.create)}}" action="" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="row align-items-end">
                    ...
                    <div class="col-md-12 form-group mb-3">
                       ...
                       <div class="col-md-7 form-group">
                           ...
                           <textarea type="text" name="remark" id="remark" class="form-control form-control-sm rounded-0" placeholder="Enter Remark"> </textarea>
                       </div>
