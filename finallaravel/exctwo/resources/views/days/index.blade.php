        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="#" class="text-danger ms-2 delete-btns" data-idx="{{$day -> id}}"><i class="fas fa-trash-alt"></i></a>                   
                </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0">
            ...
            <div class="modal-body">
                <form id="{{route('days.store')}}" action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0">
            ...
            <div class="modal-header">
                ...
                <button type="day" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
