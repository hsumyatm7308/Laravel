                    ...
                    <div class="row">
                        <div class="col-md-6 text-sm-center">
                            <label for="image" class="gallery">
                                <img src="{{asset($role -> image)}}" alt="{{$role->name}}" class="rounded-circle" width="200" />
                            </label>
                        </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="file" name="image" id="image" class="form-control form-control-lg rounded-0" placeholder="Enter your image" value="{{$role->image}}"  />
                        </div>
    
                       <div class="col-md-6 form-group mb-3">
                           <label for="name"> Name <span class="text-danger">*</span></label>
                           <input type="text" name="name" id="name" class="form-control form-control-lg rounded-0" placeholder="Enter your Role name" value="{{$role->name}}" />
                       </div>
